  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 pt-24 min-h-screen">
      <section className="text-center mb-12">
        ...
        <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight text-slate-100 mb-4">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-12">
        <article className="rounded-3xl border border-white/10 bg-slate-800/40 p-6">
          <h2 className="text-xl font-bold text-white mb-3">Vehicle-Based Search</h2>
        ...
        <article className="rounded-3xl border border-white/10 bg-slate-800/40 p-6">
          <h2 className="text-xl font-bold text-white mb-3">General Spare Parts</h2>
          <p className="text-slate-300 leading-relaxed">
        ...
        <article className="rounded-3xl border border-white/10 bg-slate-800/40 p-6">
          <h2 className="text-xl font-bold text-white mb-3">College Project Ready</h2>
          <p className="text-slate-300 leading-relaxed">
      ...
      <section className="rounded-3xl border border-white/10 bg-slate-800/30 p-8 mb-12">
        <h2 className="text-2xl font-bold text-white mb-4">What makes AutoMart different</h2>
      ...
      <section className="text-center">
        <h2 className="text-3xl font-bold text-slate-100 mb-4">Start browsing now</h2>
